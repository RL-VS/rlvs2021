...
If you already have a Matrix.org account, please follow [these instructions](matrix/Matrix_RLVS_server.pdf). If you don't, please follow [these instructions](matrix/matrix.pdf). You don't need to be a registered participant for that.
